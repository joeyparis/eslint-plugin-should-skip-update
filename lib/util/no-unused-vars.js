        ...
        for (i = 0, l = variables.length; i < l; ++i) {
          ...
          if (def) {
            ...
            if (type === 'Parameter') {
              ...
              if (config.args === 'after-used' && isFunction(def.name.parent) && !isAfterLastUsedArg(variable)) {
                continue;
              }
            } else {
      ...
      'Program:exit'(programNode) {
        ...
        for (let i = 0, l = unusedVars.length; i < l; ++i) {
          ...
          if (unusedVar.defs.length > 0) {
            ...
            errors.push({
              node: programNode,
              loc: getNameLocationInGlobalDirectiveComment(sourceCode, directiveComment, unusedVar.name),
              messageId: 'unusedVar',
...
export default noUnusedVars;
  ...
  const create = noUnusedVars.create
